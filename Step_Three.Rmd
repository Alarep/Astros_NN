...
plot(predictedValsBB, residualBB, main = "Residual plot of breaking balls", xlab = "Predicted", ylab = "Observed")

observedFB = testNN$FastBall
predictedValsFB = predict(bangTrainModel, testNN)
residualFB = observedFB - predictedValsFB
plot(observedFB - predictedValsFB,main = "Residual plot of fast balls", xlab = "Predicted", ylab = "Observed")

observedCH = testNN$Changeup
predictedValsCH = predict(bangTrainModel, testNN)
residualCH = observedCH - predictedValsCH
plot(observedCH - predictedValsCH, main = "Residual plot of change-ups", xlab = "Predicted", ylab = "Observed")
```
