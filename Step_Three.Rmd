...
```{r}
# Renaming column names in normalized test and training sets for readability.
# Testing set
setnames(trainedNN, 
         old = c('final_away_runs',
                 ...
                 'pitch_category_FB',
                 'pitch_category_OT',
                 'has_bangs_n', 'has_bangs_y', 'numOfBangs_1B', 'numOfBangs_2B', 'numOfBangs_3B', 'numOfBangs_0'), 
         new = c('AwayScore',
                 'HomeScore',
                 'ChangeupPitch',
                 'CurveballPitch',
...
nnFormula <- "BreakingBall + Changeup + FastBall + UnknownType~."
